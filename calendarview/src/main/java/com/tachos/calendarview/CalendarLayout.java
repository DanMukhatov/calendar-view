...
//    private static final int GESTURE_MODE_ONLY_CALENDAR = 1;
    ...
    public CalendarLayout(Context context, AttributeSet attrs) {
        ...
        mBgCalendar = array.getResourceId(R.styleable.CalendarLayout_calendar_background, GESTURE_MODE_DEFAULT);
        mBgColor = array.getColor(R.styleable.CalendarLayout_calendar_background_color, 0);
        mRootBgColor = array.getColor(R.styleable.CalendarLayout_calendar_root_background_color, 0);
        array.recycle();
    ...
    void updateContentViewTranslateY() {
        ...
        if (mWeekPager.getVisibility() == VISIBLE) {
            ...
            mBottomView.setTranslationY(-mContentViewTranslateY);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mBottomView.setTranslationY(mBottomView.getTranslationY() + dy);
                translationViewPager();
                mLastY = y;
                break;
    ...
    protected void onFinishInflate() {
        ...
        findViewById(R.id.view_bottom_rounded).setBackgroundResource(mBgCalendar);
        findViewById(R.id.view_start).setBackgroundColor(mRootBgColor);
        findViewById(R.id.view_end).setBackgroundColor(mRootBgColor);
    ...
    public boolean expand(int duration) {
        ...
        ObjectAnimator objectAnimator2 = ObjectAnimator.ofFloat(mBottomView,
                "translationY", mBottomView.getTranslationY(), 0f);
    ...
    public boolean shrink(int duration) {
        ...
        ObjectAnimator objectAnimator2 = ObjectAnimator.ofFloat(mBottomView,
                "translationY", mBottomView.getTranslationY(), -mContentViewTranslateY);
        objectAnimator2.setDuration(duration);
    ...
    final void showContentView() {
        ...
        mBottomView.setTranslationY(getHeight() - mMonthView.getHeight());
